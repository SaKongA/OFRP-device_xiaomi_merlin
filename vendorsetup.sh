...
# 关于橙狐变量详见 fox_12.1/vendor/recovery/orangefox_build_vars.txt
	...
	# 使红米10X 4G和红米Note 9都能刷入橙狐zip卡刷包
	export TARGET_DEVICE_ALT="merlin,merlinx"
	# 使橙狐可以刷入具有机型检测限制为红米10X 4G和红米Note 9的zip卡刷包，与TARGET_OTA_ASSERT_DEVICE冲突
	# export FOX_TARGET_DEVICES="merlin,merlinx"
	...
	F=$(find "device" -maxdepth 2 -name "merlin")
	# 修改启动画面背景色为#000000
	...
	echo -e "\x1b[96mmerlin: 当你看到这个消息的时候，所有的OrangeFox Var已经添加完毕！\x1b[m"
